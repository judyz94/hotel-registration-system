        ...
        <div class="col-md-10">
            <div class="card shadow-lg">
                <div class="card-header pb-0">
                    <h4 class="card-title"><strong>{{ __('Editar Registrador ') }} <i class="fas fa-arrow-right"></i>  {{ $receptionist->name }} </strong></h4>
                </div>

                <div class="card-body">
                    <form action="{{ route('receptionists.update', $receptionist) }}" method="post" id="receptionists-form">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="observation" name="observation" placeholder="{{ __('Ingrese las observaciones') }}">{{ old('observation', $receptionist->observation) }}
                                        @error('observation')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </textarea>
